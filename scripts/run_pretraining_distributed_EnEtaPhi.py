...
def train( device, name_dir, config,  outputDir, dtype,
    ...
    train_dataset = DatasetCombined(config.input_dataset_train,dev=device,
                           ...
                           reco_list_lab=['scaledLogEnEtaPhi', 'mask_lepton', 
                                      'mask_jets','mask_met',
                                      'mask_boost', 'scaledLogBoost'],
                           parton_list_lab=['scaledLogEnEtaPhi_higgs_t_tbar_ISR',
                                        'logScaled_data_boost',
                                        'mean_scaledLogEnEtaPhi_higgs_t_tbar_ISR',
                                        'std_scaledLogEnEtaPhi_higgs_t_tbar_ISR',
                                        'mean_log_data_boost',
                                        'std_log_data_boost'])
    ...
    log_mean_parton = train_dataset.partons_lab.mean_scaledLogEnEtaPhi_higgs_t_tbar_ISR
    log_std_parton = train_dataset.partons_lab.std_scaledLogEnEtaPhi_higgs_t_tbar_ISR
